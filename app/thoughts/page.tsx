...
export default function Thoughts() {
    return (
        <div className="min-h-[100dvh] w-full flex items-start justify-center px-4 md:px-12 lg:px-32 pb-8 pt-24 md:pt-8 relative overflow-hidden selection:bg-white/20 selection:text-white">
